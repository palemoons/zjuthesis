...
\begin{figure}
  \centering
  \subcaptionbox{\label{fig:yield_city}}[.5\linewidth]{\includegraphics[width=.8\linewidth]{data/yield_city.png}}\hfill
  \subcaptionbox{\label{fig:yield_county}}[.5\linewidth]{\includegraphics[width=.8\linewidth]{data/yield_county.png}}\hfill
...
\begin{figure}
  \centering
  \subcaptionbox{地级市尺度玉米有效面积分布}[.5\linewidth]{\includegraphics[width=.8\linewidth]{result/violin_city.png}}\hfill
  \subcaptionbox{区县尺度玉米有效面积分布}[.5\linewidth]{\includegraphics[width=.8\linewidth]{result/violin_county.png}}\hfill
  \caption{样本集玉米种植面积分布}
  \label{fig:violin}
\end{figure}
...
\begin{figure}
  \centering
  \subcaptionbox{\label{fig:scatter_city}地级市尺度预估产量与实际产量的散点图}{\includegraphics[width=.75\linewidth]{result/scatter_city.png}}\hfill
  \subcaptionbox{\label{fig:scatter_county}区县尺度预估产量与实际产量的散点图}{\includegraphics[width=.75\linewidth]{result/scatter_county.png}}
...
\begin{figure}
  \centering
  \includegraphics[width=.85\linewidth]{result/error_2017.png}
...
\begin{figure}
  \centering
  \includegraphics[width=.85\linewidth]{result/error_2010.png}
